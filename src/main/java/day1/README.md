...
complete the first. Each puzzle grants <code style="color : gold">one star</code>. Good luck!
...
To begin, [get your puzzle input](https://github.com/turczak/AoC2025/blob/main/src/main/resources/inputs/day1.txt).
